...
class Kirki_Control_Dimensions extends Kirki_Control_Base {
	...
	protected function l10n() {
		return array(
			...
			'font-size'      => esc_html__( 'Font Size', 'xpro-bb-addons' ),
			'font-weight'    => esc_html__( 'Font Weight', 'xpro-bb-addons' ),
			'line-height'    => esc_html__( 'Line Height', 'xpro-bb-addons' ),
			'font-style'     => esc_html__( 'Font Style', 'xpro-bb-addons' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'xpro-bb-addons' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'xpro-bb-addons' ),
			'top'            => esc_html__( 'Top', 'xpro-bb-addons' ),
			'bottom'         => esc_html__( 'Bottom', 'xpro-bb-addons' ),
			'left'           => esc_html__( 'Left', 'xpro-bb-addons' ),
			'right'          => esc_html__( 'Right', 'xpro-bb-addons' ),
			'center'         => esc_html__( 'Center', 'xpro-bb-addons' ),
			'size'           => esc_html__( 'Size', 'xpro-bb-addons' ),
			'spacing'        => esc_html__( 'Spacing', 'xpro-bb-addons' ),
			'width'          => esc_html__( 'Width', 'xpro-bb-addons' ),
			'height'         => esc_html__( 'Height', 'xpro-bb-addons' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'xpro-bb-addons' ),
		);
	}
}
