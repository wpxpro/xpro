...
class Kirki_Control_Dimensions extends Kirki_Control_Base {
	...
	protected function l10n() {
		return array(
			...
			'font-size'      => esc_html__( 'Font Size', 'xpro' ),
			'font-weight'    => esc_html__( 'Font Weight', 'xpro' ),
			'line-height'    => esc_html__( 'Line Height', 'xpro' ),
			'font-style'     => esc_html__( 'Font Style', 'xpro' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'xpro' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'xpro' ),
			'top'            => esc_html__( 'Top', 'xpro' ),
			'bottom'         => esc_html__( 'Bottom', 'xpro' ),
			'left'           => esc_html__( 'Left', 'xpro' ),
			'right'          => esc_html__( 'Right', 'xpro' ),
			'center'         => esc_html__( 'Center', 'xpro' ),
			'size'           => esc_html__( 'Size', 'xpro' ),
			'spacing'        => esc_html__( 'Spacing', 'xpro' ),
			'width'          => esc_html__( 'Width', 'xpro' ),
			'height'         => esc_html__( 'Height', 'xpro' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'xpro' ),
		);
	}
}
