...
class Kirki_L10n {
	 ...
	 * @var string
	 */
	private $textdomain = 'xpro-bb-addons';
	...
	public function override_load_textdomain( $override, $domain, $mofile ) {
		...
		if ( isset( $l10n[ $this->get_theme_textdomain() ] ) ) {
			$l10n['xpro-bb-addons'] = $l10n[ $this->get_theme_textdomain() ]; // phpcs:ignore WordPress.WP.GlobalVariablesOverride
		}

		// Check if the domain is "kirki".
		if ( 'xpro-bb-addons' === $domain ) {
			return true;
		}
		return $override;
	}
