...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'xpro-bb-addons' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'xpro-bb-addons' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'xpro-bb-addons' ),
			'200'       => esc_html__( 'Light 200', 'xpro-bb-addons' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'xpro-bb-addons' ),
			'300'       => esc_html__( 'Book 300', 'xpro-bb-addons' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'xpro-bb-addons' ),
			'400'       => esc_html__( 'Normal 400', 'xpro-bb-addons' ),
			'regular'   => esc_html__( 'Normal 400', 'xpro-bb-addons' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'xpro-bb-addons' ),
			'500'       => esc_html__( 'Medium 500', 'xpro-bb-addons' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'xpro-bb-addons' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'xpro-bb-addons' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'xpro-bb-addons' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'xpro-bb-addons' ),
			'700'       => esc_html__( 'Bold 700', 'xpro-bb-addons' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'xpro-bb-addons' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'xpro-bb-addons' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'xpro-bb-addons' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'xpro-bb-addons' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'xpro-bb-addons' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'xpro-bb-addons' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'xpro-bb-addons' ),
		);
	}
