...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'xpro' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'xpro' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'xpro' ),
			'200'       => esc_html__( 'Light 200', 'xpro' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'xpro' ),
			'300'       => esc_html__( 'Book 300', 'xpro' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'xpro' ),
			'400'       => esc_html__( 'Normal 400', 'xpro' ),
			'regular'   => esc_html__( 'Normal 400', 'xpro' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'xpro' ),
			'500'       => esc_html__( 'Medium 500', 'xpro' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'xpro' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'xpro' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'xpro' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'xpro' ),
			'700'       => esc_html__( 'Bold 700', 'xpro' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'xpro' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'xpro' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'xpro' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'xpro' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'xpro' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'xpro' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'xpro' ),
		);
	}
